...
{
    [Theory]
    [InlineData(DatabaseProvider.SqlServer, typeof(AkkornStudio.Providers.SqlServerOrchestrator))]
    [InlineData(DatabaseProvider.MySql, typeof(AkkornStudio.Providers.MySqlOrchestrator))]
    [InlineData(DatabaseProvider.Postgres, typeof(AkkornStudio.Providers.PostgresOrchestrator))]
    [InlineData(DatabaseProvider.SQLite, typeof(AkkornStudio.Providers.SqliteOrchestrator))]
