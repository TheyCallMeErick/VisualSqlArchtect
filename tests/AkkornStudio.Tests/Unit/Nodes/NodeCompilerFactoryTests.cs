using AkkornStudio.Nodes.Compilers;
using AkkornStudio.Registry;
using NodeModel = AkkornStudio.Nodes;
...
public sealed class NodeCompilerFactoryTests
{
    ...
    private sealed class FakeCompilationContext : INodeCompilationContext
    {
        private static readonly NodeModel.EmitContext EmitCtx = new(
            AkkornStudio.Core.DatabaseProvider.Postgres,
            new SqlFunctionRegistry(AkkornStudio.Core.DatabaseProvider.Postgres));
