...
namespace AkkornStudio.Tests.Unit.Services.Input.ShortcutRegistrySubsystem;
...
public sealed class ShortcutRegistryTests
{
    ...
    private global::AkkornStudio.UI.Services.Input.ShortcutRegistry.ShortcutRegistry CreateRegistry() =>
        new(
