...
namespace AkkornStudio.Tests.Unit.Services.Input.ShortcutRegistry;
...
public sealed class ShortcutExecutionServiceTests
{
    ...
    {
        IShortcutRegistry registry = new global::AkkornStudio.UI.Services.Input.ShortcutRegistry.ShortcutRegistry(
