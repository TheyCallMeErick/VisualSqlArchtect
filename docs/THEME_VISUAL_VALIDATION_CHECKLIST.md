...
1. Copiar o arquivo [src/VisualSqlArchitect.UI/Assets/Themes/user-theme.high-contrast.sample.json](src/VisualSqlArchitect.UI/Assets/Themes/user-theme.high-contrast.sample.json).
2. Substituir temporariamente o conteudo de [src/VisualSqlArchitect.UI/Assets/Themes/user-theme.json](src/VisualSqlArchitect.UI/Assets/Themes/user-theme.json) pelo tema de contraste.
...
- [ ] Retornar [src/VisualSqlArchitect.UI/Assets/Themes/user-theme.json](src/VisualSqlArchitect.UI/Assets/Themes/user-theme.json) para o perfil desejado (default ou customizado).
