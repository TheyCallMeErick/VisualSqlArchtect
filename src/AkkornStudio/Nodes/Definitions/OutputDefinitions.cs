...
public static class OutputDefinitions
{
    ...
    public static readonly NodeDefinition ResultOutput = new(
        ...
        [
            new("distinct", AkkornStudio.Nodes.ParameterKind.Boolean, "false", "Emit SELECT DISTINCT"),
            new("query_hints", AkkornStudio.Nodes.ParameterKind.Text, "", "Engine-specific query hints"),
            new(
                "set_operator",
                AkkornStudio.Nodes.ParameterKind.Enum,
                "",
                "Legacy set operation operator",
            ...
            new(
                ...
                "",
                "Legacy set operation right-side query"
            ),
            new(
                "pivot_mode",
                AkkornStudio.Nodes.ParameterKind.Enum,
            ...
            new(
                ...
                AkkornStudio.Nodes.ParameterKind.Text,
                "",
                "Pivot/Unpivot configuration payload"
            ),
            new(
                "file_name",
                AkkornStudio.Nodes.ParameterKind.Text,
