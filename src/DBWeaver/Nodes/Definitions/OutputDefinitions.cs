...
public static class OutputDefinitions
{
    ...
    public static readonly NodeDefinition ResultOutput = new(
        ...
        [
            new("distinct", DBWeaver.Nodes.ParameterKind.Boolean, "false", "Emit SELECT DISTINCT"),
            new("query_hints", DBWeaver.Nodes.ParameterKind.Text, "", "Engine-specific query hints"),
            new(
                "set_operator",
