...
using VisualSqlArchitect.UI.Services.SqlImport.Contracts;
...
using VisualSqlArchitect.UI.Services.SqlImport.Validation;
using VisualSqlArchitect.UI.ViewModels;
using VisualSqlArchitect.UI.ViewModels.Canvas;

namespace VisualSqlArchitect.UI.Services.SqlImport.Execution;
...
) : ISqlImportExecutionService
{
    ...
    )
    {
        ...
        var coreInput = new ImportBuildInput(
            parsed.FromParts.Select(p => new ImportFromPart(p.Table, p.JoinType, p.OnClause)).ToList(),
