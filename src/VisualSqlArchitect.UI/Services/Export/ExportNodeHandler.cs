...
namespace VisualSqlArchitect.UI.Services.Export;
...
<title>{{title}}</title>
<style>
  :root{--bg:#0f172a;--surface:#1e293b;--border:#334155;--text:#e2e8f0;--accent:#38bdf8;--muted:#94a3b8;--code:#1e293b}
  ...
  pre{margin:0;white-space:pre-wrap;word-break:break-all;font-family:'Fira Code',monospace;font-size:.875rem;color:#86efac}
  table{width:100%;border-collapse:collapse;font-size:.875rem}
  th{background:#0f172a;color:var(--accent);padding:.5rem .75rem;border:1px solid var(--border);text-align:left}
  td{padding:.5rem .75rem;border:1px solid var(--border);color:var(--muted);font-style:italic}
  .badge{display:inline-block;background:#1d4ed8;color:#bfdbfe;padding:.125rem .5rem;border-radius:999px;font-size:.75rem}
</style>
</head>
<body>
<h1>{{HtmlEncode(title)}}</h1>
<p class="meta">Generated by <strong>Visual SQL Architect</strong> &nbsp;·&nbsp; {{ts}} &nbsp;·&nbsp; <span class="badge">{{columns.Count}} column(s)</span></p>
