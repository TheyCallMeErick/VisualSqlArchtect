...
public sealed class QueryGraphBuilder(CanvasViewModel canvas, DatabaseProvider provider)
{
        ...
        out List<string> errors)
    {
        ...
        List<NodeViewModel> cteDefinitions = _canvas.Nodes.Where(n => n.Type == NodeType.CteDefinition).ToList();
        ...
        List<NodeViewModel> subqueryNodes = _canvas.Nodes.Where(n => n.Type == NodeType.Subquery).ToList();
        ...
        try
        {
            ...
            GeneratedQuery result = svc.Generate(fromTable, graph);
