...
public sealed class ConnectionHealthMonitorService : IConnectionHealthMonitorService
{
    ...
    public async Task<EConnectionHealthStatus> EvaluateStatusAsync(
    ...
    {
        if (profile is null)
            return EConnectionHealthStatus.Unknown;
        ...
        try
        {
            ...
            if (!result.Success)
                return EConnectionHealthStatus.Offline;
        ...
        catch (OperationCanceledException)
        {
            return ct.IsCancellationRequested
                ...
                : EConnectionHealthStatus.Offline;
        }
        catch
        {
            return EConnectionHealthStatus.Offline;
