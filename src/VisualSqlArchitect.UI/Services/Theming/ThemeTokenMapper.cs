...
public static class ThemeTokenMapper
{
    public static ThemeTokenMapResult Map(ThemeConfig config)
    {
        ...
        {
            MapColor(config.Colors.MacroBg0, "MacroBg0", "MacroBg0Brush", result);
            MapColor(config.Colors.MacroBg1, "MacroBg1", "MacroBg1Brush", result);
            MapColor(config.Colors.MacroBg2, "MacroBg2", "MacroBg2Brush", result);
        ...
        if (config.Typography is not null)
        {
            ...
            MapSize(config.Typography.MetaSize, "FontSizeMeta", result);
        }
