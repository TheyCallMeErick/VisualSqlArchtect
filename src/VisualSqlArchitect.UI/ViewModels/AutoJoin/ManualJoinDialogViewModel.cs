...
public sealed class ManualJoinColumnOption
{
    ...
    {
        PinDataType.Text => "#22D3EE",
        PinDataType.Integer or PinDataType.Decimal or PinDataType.Number => "#60A5FA",
        PinDataType.Boolean => "#34D399",
        PinDataType.DateTime => "#C084FC",
        PinDataType.Json => "#F59E0B",
        _ => "#9CA3AF",
    };
}
