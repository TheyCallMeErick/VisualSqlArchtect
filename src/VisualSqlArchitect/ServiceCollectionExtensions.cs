...
public sealed class VisualSqlArchitectServiceOptions
{
...
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddVisualSqlArchitect(this IServiceCollection services) =>
        AddVisualSqlArchitect(services, configure: null);

    /// <summary>
    /// Registers all Visual SQL Architect services with optional overrides for default registrations.
    /// </summary>
    public static IServiceCollection AddVisualSqlArchitect(
        this IServiceCollection services,
        Action<VisualSqlArchitectServiceOptions>? configure
    )
    {
        var options = new VisualSqlArchitectServiceOptions();
