using System.Text;
using AkkornStudio.UI.Services.AppDiagnostics.Contracts;
using AkkornStudio.UI.Services.AppDiagnostics.Models;
using AkkornStudio.UI.Services.Localization;

namespace AkkornStudio.UI.Services.AppDiagnostics.Presentation;
...
public sealed class AppDiagnosticsReportBuilder(ILocalizationService localization) : IAppDiagnosticsReportBuilder
{
    ...
    public string BuildReport(string overallLabel, IEnumerable<AppDiagnosticCategoryViewModel> categories)
    {
        ...
        sb.AppendLine(L("diagnostics.report.title", "AkkornStudio - Diagnostic Report"));
